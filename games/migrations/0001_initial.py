# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-03-01 03:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('away_team_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='away_team_games', to='teams.Team', to_field='team_id')),
                ('home_team_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='home_team_games', to='teams.Team', to_field='team_id')),
            ],
        ),
        migrations.CreateModel(
            name='HomeRun',
            fields=[
                ...
                ('team', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='teams.Team', to_field='team_code')),
            ],
        ),
        migrations.CreateModel(
            name='Inning',
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='games.Game')),
                ('team', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='teams.Team', to_field='team_id')),
            ],
        ),
        migrations.CreateModel(
            name='LosingPitcher',
